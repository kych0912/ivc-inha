...
export default function Recruit() {
    ...
    <div className="w-full bg-[#1b1b1b] flex flex-col items-center justify-center text-[calc(10px+2vmin)] text-[#bd3232] min-h-screen bg-[url('/IVC_BG1.gif')] bg-center bg-no-repeat bg-[length:100vh]">
        <div className="flex flex-col items-center justify-center pt-8">
            ...
            <h1 className="text-white text-5xl font-suit font-bold">
                RECRUIT
            </h1>

            <div className="flex flex-col items-center justify-center max-w-[750px] pb-10">
                <div className="flex">
                <p className="text-white text-3xl md:text-5xl font-suit pt-8">
                    당신의 &nbsp;
                </p>
                ...
                <p className="text-white text-3xl md:text-5xl font-suit pt-3">
                    함께하기를
                </p>
                </div>
            </div>
            ...
            <div className="flex">
                ...
                <div>
                    ...
                    <button className="border border-white text-white p-2">
                        <p className="text-white text-xl md:text-3xl font-suit font-bold w-[130px] md:w-[200px]">
                        지원서 제출
                        </p>
                    </button>
